...
default_annotation_path = '../annotations/train.txt'       # to change
default_log_dir = 'logs/000/'
default_classes_path = '../model_data/coco_classes.txt'    # to change
...
def _run(annotation_path=default_annotation_path, log_dir=default_log_dir, model_path=default_model_path,
    ...
    return history_freezed, history_unfreezed
